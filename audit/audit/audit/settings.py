...
SECRET_KEY = 'django-insecure-2j9o%_5c^)zzrozu1=_jn*ldq@ux#0bjxuafik=ffkek*%2l4b'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # Путь к корневой папке static/
...
# Для Slither (если нужны дополнительные настройки)
SLITHER_SETTINGS = {
    'disable_color': True,
